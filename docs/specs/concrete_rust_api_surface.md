...
Both compile forms accept supported validated user-module instances and retain
their hierarchy and qualified stable correspondence while lowering execution
into the ordinary primitive runtime machinery.
