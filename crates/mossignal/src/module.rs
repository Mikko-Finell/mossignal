...
fn normalized_node<D>(node: &NodeDef<D>) -> NodeDef<D> {
    ...
    let mut outputs: Vec<_> = node
        ...
        .iter()
        .copied()
        .zip(node.ports().output_roles().iter().copied())
        .collect();
    outputs.sort_by_key(|(key, role)| (*key, *role));
    let (outputs, output_roles): (Vec<_>, Vec<_>) = outputs.into_iter().unzip();
    NodeDef::new(
        node.key(),
        node.kind().clone(),
        NodePorts::with_roles(inputs, roles, outputs, output_roles),
        node.meta().clone(),
    )
}
...
mod tests {
    ...
    #[test]
    fn level_controlled_pulse_module_vector_is_exact() {
        let mut builder = ModuleBuilder::<()>::new();
        let (_, selector) = builder.level_input("selector");
        let (_, gate_pulses) = builder.pulse_input("gate-pulses");
        let (_, low_pulses) = builder.pulse_input("low-pulses");
        let (_, high_pulses) = builder.pulse_input("high-pulses");
        let gated = builder
            .pulse_gate(gate_pulses, selector)
            .unwrap_or_else(|failure| panic!("gate must author: {failure:?}"));
        ...
        let routed = builder
            ...
            .unwrap_or_else(|failure| panic!("route must author: {failure:?}"));
        builder
            .pulse_output("gate", gated)
            .and_then(|_| builder.pulse_output("select", selected))
            .and_then(|_| builder.pulse_output("route-low", routed.when_low))
            .and_then(|_| builder.pulse_output("route-high", routed.when_high))
            .unwrap_or_else(|failure| panic!("outputs must author: {failure:?}"));
        let module = builder.into_unchecked();
        let bytes = canonical_module_input(&module);
        let fingerprint = module
            .validate_ref()
            .artifact()
            .unwrap_or_else(|| panic!("family module validates"))
            .fingerprint();
        assert_eq!(
            hex(&bytes),
            ""
        );
        assert_eq!(
            fingerprint.to_string(),
            "998aa8c7e4652e901f005d23df954f5f6dc7da73d2073578960ec0c1a3f5d4dd"
        );
    }
